    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-16 bg-gradient-luxury border-b border-gold-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gradient">Our Products</h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Discover our carefully curated selection of premium coffees, each crafted to deliver an unforgettable experience.
            </p>
          </motion.div>
        </div>
      </section>
